      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="button-submit">
            <a href="<?php echo base_url($action.'/'.$nameSection.'/create/?id='.$id_section); ?>" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus"></i>&nbsp;&nbsp; Create <?php echo ucfirst($nameSection); ?></a>
          </div>
        </div>
        <!-- /.box-header -->
